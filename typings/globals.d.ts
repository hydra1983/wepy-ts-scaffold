...
declare module 'wepy' {
  ...
  class App {
    // $init(app): void
    // 使用中间件 ( requestfix | promisify )
    use(addon: string | PlainObject): void
  ...
  class Component {
    setData(key: string | PlainObject, value?: PlainObject): void

    getWxPage<T>(): T

    getCurrentPages<T>(): T

    $getComponent<T>(com: string): T

    $invoke(com: string | Component, method: string, ...args): void
    ...
    $nextTick(fn: Function): Promise<void>
  }

  class Page extends Component {
    $route(type: string, url: string | PlainObject): void

    $redirect(url: string, params): void

    $navigate(url: string, params): void

    $switch(url: string): void

    $back(delta: number | PlainObject): void
  }

  // @ts-ignore: TS2714: The expression of an export assignment must be an identifier or qualified name in an ambient
  // context.
  export default {
    event: event,
    app: App,
  ...
  export interface Animation {
     ...
     * rotate3d](https://developer.mozilla.org/en-US/docs/Web/CSS/transform-function/rotate3d?t=1477656494026)
     */
    ...
    /**
     * 同 [transform-function
     * matrix](https://developer.mozilla.org/en-US/docs/Web/CSS/transform-function/matrix?t=1477656494026)
     */
    matrix(a: number, b: number, c: number, d: number, tx: number, ty: number): this;

    /**
     * 同 [transform-function
     * matrix3d](https://developer.mozilla.org/en-US/docs/Web/CSS/transform-function/matrix3d?t=1477656494026)
     */
   ...
   */
  export function getUserInfo(options: GetUserInfoOptions): Promise<void>;
